        ...
        <tr>
            <td colspan="2">
                ...
                <div class="alert alert-info">
                    <i><b><span style="font-size: 16px;">NOTE:</span> <span style="font-size: 14px;">You must create an account before you can enroll in a course. To create an account, click on the "My Account" button above and fill in the REGISTER information.</span></b></i>
                </div>
                <?php endif; ?>
