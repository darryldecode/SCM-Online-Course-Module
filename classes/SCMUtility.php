...
class SCMUtility {
    ...
    public static function redirect($query_string)
    {
        ...
        $url = rtrim($site_url,'/');
        $adminUrl = $url.'/wp-admin/admin.php';
    ...
    public static function adminBuildUrl($query_string)
    {
        ...
        $site_url = get_site_url();
        $url = rtrim($site_url,'/');
        $adminUrl = $url.'/wp-admin/admin.php'.$query_string;
    ...
    public static function frontRedirectTo($query_string)
    {
        ...
        // build the whole url
        $actual_link = get_site_url() . $course_url .  $query_string;
    ...
    /**
     * helper to check if email already exist
     *
     * @param $email
     * @return bool
     */
