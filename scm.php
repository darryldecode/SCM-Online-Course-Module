...
use SCM\Classes\SCMInstaller2 as Installer2;
use Illuminate\Database\Capsule\Manager as Capsule;

/**
 * Plugin Name: Online Course Module
 * Plugin URI: https://github.com/darryldecode
 * Description: Online Course Module with PayPal Advance payment Integration
 * Version: 1.0
...
class SCMBootstrap {
    ...
    public static function defineConstants()
    {
        ...
        define('SCM_URI',	    plugins_url().'/scm-module/');
        define('SCM_URI_CSS',	plugins_url().'/scm-module/resources/css/');
        define('SCM_URI_JS',	plugins_url().'/scm-module/resources/js/');
        define('SCM_URI_IMG',	plugins_url().'/scm-module/resources/img/');
    }
    ...
    {
        $page_title		= 'SCM COURSE';
        $menu_title		= 'Online Course Module';
        $capability		= 'activate_plugins';
        $menu_slug		= 'scmCourseModule';
